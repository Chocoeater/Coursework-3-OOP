...
def test_add_vacancy_success(json_saver, vacancy):
...
def test_delete_vacancy_success(json_saver, vacancy):
...
def test_search_vacancies_by_keyword(json_saver, vacancy):
...
def test_search_vacancies_by_salary(json_saver, vacancy):
...
def test_get_all_vacancies(json_saver, vacancy):
